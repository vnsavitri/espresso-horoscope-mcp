...
A local-first MCP project that turns espresso shot metrics and a birth date into a personalised "cosmic" reading, generated offline with a local GPT-OSS model through LM Studio.
